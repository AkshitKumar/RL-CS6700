...
def saveEvaluation(eval_return,eval_num_of_step,num):
	...
	np.save('eval_goal_a/eval_return_agent_' + str(num),eval_return)
	np.save('eval_goal_a/eval_num_steps_agent_' + str(num),eval_num_of_step)
...
for i in range(len(goal_states)):
	for j in range(num_of_agents):
		...
		np.save('returns_goal_a/return_' + 'agent_' + str(j) + '_goal_' + goal_states[i],returns)
		np.save('num_steps_goal_a/num_step_' + 'agent_' + str(j) + '_goal_' + goal_states[i],num_steps)
